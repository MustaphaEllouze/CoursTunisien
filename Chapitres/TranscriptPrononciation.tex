...
\h{Transcription adoptée et prononciation}
\l{D}ans ce chapitre, je vous propose d'en apprendre plus sur la transcription que j'ai choisie afin d'écrire le tunisien dans ce cours, ainsi que les différents sons qui composent la langue.

\hh{Sons que vous pouvez rencontrer en tunisien}
...
\hhh{Consonne ayant évolué depuis l'arabe}
...
\hhh{Consonnes d'origine étrangère}
...
\hh{Transcription utilisée dans ce cours}
...
\hhh{Transcription des consonnes et des voyelles}
...
\hhh{Transcription des voyelles longues et consonnes géminées}
